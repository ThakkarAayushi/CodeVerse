...
<div class="left-sidebar-pro" style = "fontfamily : font-family: 'Roboto', sans-serif ";>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                      ...
                      <li>
					   <a title="Dashboard" href="dashboard"> 
					    ...
					    <span class="mini-sub-pro">Dashboard</span>
					</a>
					</li>
					...
					<li> <a class="has-arrow" href="#" aria-expanded="false">
					    ...
					    <ul class="submenu-angle collapse" aria-expanded="false"> <li>
					            <a title="Add User" href="register">
					                <span class="mini-sub-pro">Add User</span>
					            </a>
					        </li>
					        <li>
					            <a title="List User" href="listUser">
					                <span class="mini-sub-pro">List User</span>
					            </a>
					        </li>
					        <li>
					            <a title="List User" href="newUserType">
					                <span class="mini-sub-pro">Add User Type</span>
					            </a>
					        </li>
					          <li>
					            <a title="List User" href="logout">
					                <span class="mini-sub-pro">Logout</span>
					            </a>
					        </li>
					    </ul>
					</li>
                        <li>
                           <a class="has-arrow" href="dashboard">
							...
							<ul class="submenu-angle" aria-expanded="false">
							    <li><a title="Add Category" href="newCategory"><span class="mini-sub-pro">Add Category</span></a></li>
							    <li><a title="List Category" href="listCategory"><span class="mini-sub-pro">List Category</span></a></li>
							</ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false">
	                            <i class="icon nalika-diamond icon-wrap"></i>
	                             <span class="mini-click-non">Manage Event</span>
                             </a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="newhackathon" href="create-hackathon"><span class="mini-sub-pro">Add Hackathon</span></a></li>

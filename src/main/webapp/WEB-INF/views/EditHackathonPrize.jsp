...
<title>Edit Hackathon Prize | CodeVerse Admin</title>
    ...
    <div class="main-content">
        ...
        <div class="content-area">
            <div class="page-header-section" style="margin-bottom: 24px;">
                <h1 class="page-title" style="font-size: 1.5rem; font-weight: 700; color: #0f172a; margin-bottom: 8px;">Edit Hackathon Prize</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="background:transparent; padding:0; margin:0;">
                        ...
                        <li class="breadcrumb-item active" style="color: #64748b;">Edit Prize</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="form-card">
                <div class="card-header-custom">
                    <h3><i class="fas fa-edit"></i> Edit Prize</h3>
                    <a href="listHackathonPrize?hackathonId=${prize.hackathonId}" class="btn btn-secondary" style="padding: 8px 15px; font-size: 0.8rem;">
                ...
                <form action="updateHackathonPrize" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="prizeTitle" value="${prize.prizeTitle}" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <textarea name="prizeDescription" rows="6" required>${prize.prizeDescription}</textarea>
                        </div>
                    </div>

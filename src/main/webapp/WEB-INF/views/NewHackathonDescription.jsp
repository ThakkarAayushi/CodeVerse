...
<title>New Hackathon Description | CodeVerse Admin</title>
<!-- Fonts & Icons -->
    ...
    <div class="main-content">
        ...
        <div class="content-area">
            <div class="page-header-section" style="margin-bottom: 24px;">
                <h1 class="page-title" style="font-size: 1.5rem; font-weight: 700; color: #0f172a; margin-bottom: 8px;">New Hackathon Description</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="background:transparent; padding:0; margin:0;">
                        <li class="breadcrumb-item"><a href="dashboard" style="text-decoration: none; color: #3b82f6;">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="listHackathonDescription" style="text-decoration: none; color: #3b82f6;">Descriptions</a></li>
            ...
            <div class="form-card">
                <div class="card-header-custom">
                    <h3><i class="fas fa-file-alt"></i> Add Description</h3>
                    <a href="listHackathonDescription" class="btn btn-secondary" style="padding: 8px 15px; font-size: 0.8rem;">
                ...
                <form action="saveHackathonDescription" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <textarea name="hackathonDetails" rows="10" placeholder="Enter detailed description, rules, and guidelines..." required></textarea>
                        </div>
                    </div>
